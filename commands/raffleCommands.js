...
module.exports.run = async (bot, message, args) => {
  const embed = new Discord.MessageEmbed()
    ...
    //Raffle Commands
    .addField(
      "**!rafflestart Raffle @role Raffle Name**",
      `Starts a raffle for the specified discord role.`
    )
    .addField("**!rafflejoin RaffleName**", `Joins the specified raffle.`)
    .addField(
      "**!rafflewinner RaffleName**",
      `Randomly selects a winner for the specified raffle.`
    )
